...
export function ArticleClient({ htmlContent }: ArticleClientProps) {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground relative selection:bg-cyan-400/30 font-sans pb-20 overflow-x-hidden">
            ...
            <div className="absolute top-[30%] right-[-10%] w-[500px] h-[500px] bg-cyan-400/5 dark:bg-cyan-400/5 rounded-full blur-[130px] pointer-events-none -z-10" />
